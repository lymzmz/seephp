...
<?php echo see_engine_kernel::lang("这是备注"); ?><br/>
<?php echo see_engine_kernel::lang("欢迎回来"); ?><?php echo $username; ?>a<br/>
<a href="<?php echo see_engine_kernel::url("base/default/logout"); ?>"><?php echo see_engine_kernel::url("base/default/logout"); ?></a>
...
bbbbbbbbbbbbbbbbbbbbbbbbbccccccccccccccccccccccccccc
<img src="http://localhost/seephp/statics/images/<?php echo "logo.gif"; ?>"/>
</div>